...
description: Anleitung zur Ausführung des FeathersJS-Service-Generators mit Optionen, Beispielen und Übersicht der erzeugten Artefakte.
tags: [nx, generators, feathers]
status: stable
generated: { by: claude-code/historic, at: 2025-02-13T00:00:00Z }
---
...
- **Service Pattern:** `docs/guides/service-creation-guide.md`
