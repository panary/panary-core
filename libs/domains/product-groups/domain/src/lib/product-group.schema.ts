...
export const productGroupSchema = Type.Object(
  {
    ...
    acronym: Type.Optional(Type.String({ maxLength: 32 })),
    color: Type.String({ maxLength: 32 }),
    excluded: Type.Boolean(),
    index: Type.Integer({ minimum: 0 }),
    taxInside: Type.Number({ default: 19, minimum: 0, maximum: 100 }),
    taxOutside: Type.Number({ default: 7, minimum: 0, maximum: 100 }),
  },
