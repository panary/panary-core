...
description: Historische Badge-Lösung für Sync-Alter- und Token-Ablauf-Warnungen in POS und Admin, abgelöst durch das priorisierte Einzel-Banner-System.
tags: [cloud-connection, ui, sync]
status: deprecated
...
- [ ] Doku in `docs/index.md` referenziert
...
**Doku:**
- `docs/index.md` — Eintrag in „Architektur"-Sektion
- `docs/architecture/cloud-status-badge.md` — dieser Plan; nach Implementation auf `status: implemented` setzen
