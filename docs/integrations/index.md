...
* [Print-Server-API](print-server-api.md) - Referenz der Print-Server-Schnittstelle am Edge — Aufrufer, Ziel-Host und Fehler-Events, der mitgelieferte MQTT-Broker, die ESC/POS-Encoder-Library samt der in Dots gemessenen Zentrierungsfalle bei Font B, das Rendern je Zieldrucker und die Druckerrolle, die über Küchenbon oder vollständige Quittung entscheidet.
