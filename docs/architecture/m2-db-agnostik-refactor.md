...
description: Refactor aller Edge-Services auf das Hybrid-Adapter-Pattern mit ensureIndexes, getJsonFieldHooks und Schema-First, damit derselbe Service-Code auf SQLite und MongoDB läuft.
tags: [api-edge, shared-backend, orders, products, sqlite, mongodb]
status: stable
generated: { by: claude-code/historic, at: 2026-04-24T00:00:00Z }
---
...
- [ensureIndexes-Entwicklungs-Guide](../guides/ensure-indexes-guide.md)
- [Service-Erstellungsanleitung](../guides/service-creation-guide.md)
