...
* [„OHNE"-Modifier — Marker `amount −1`, Preisregel und Bon-Darstellung](modifier-ohne-marker.md) - Ein Modifier mit amount −1 ist der POS-Marker für „OHNE <Extra>": schema-seitig nur auf Modifier-Ebene erlaubt, preisneutral in beiden Brutto-Rechenpfaden und auf dem Bon als „OHNE …" ohne Betrag gedruckt.
