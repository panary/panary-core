...
description: Feldbezogene Inline-Constraints (maxLength, minimum, maxItems, pattern) über alle Domänen gegen Dokument-Aufblähung; Entscheidung für Inline-Limits statt zentraler Constraint-Bibliothek und Beibehalt von Type.Any.
tags: [security, validation, typebox, users, orders, products, sync, customers]
status: stable
decision: accepted
