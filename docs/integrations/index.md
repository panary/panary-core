...
* [Print-Server-API](print-server-api.md) - Referenz der Print-Server-Schnittstelle am Edge — Aufrufer, Ziel-Host und Fehler-Events, der mitgelieferte MQTT-Broker, die ESC/POS-Encoder-Library samt der in Dots gemessenen Zentrierungsfalle bei Font B, der Kopfbereich des Bestellbons und das Rendern je Zieldrucker statt eines Buffers für alle.
