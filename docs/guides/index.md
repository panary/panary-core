...
* [Test-Target an einer Nx-Lib nachrüsten](lib-vitest-test-target.md) - Anleitung, wie eine Lib ohne `test`-Target eines per Plugin-Inferenz bekommt — inklusive der fünf Fallen (Config-Drift, TS5069, fehlender JIT-Compiler, `effect()` ohne Scheduler, Cross-Lib-Import lädt dist-`.d.ts`) und des TestBed-freien Musters für Angular-Klassen.
