...
date: 2026-07-04
category: Sicherheit
domains: [orders, sync, devices, apikeys, platform-tenants]
...
`panary-cloud/documentation/versions-konsistenz-und-update-hinweis.md`.

---

## 5. Verwandte Dokumentation

- `panary-core/documentation/rabatte.md` — discount-mutex im Kontext des Rabatt-Datenmodells
- `panary-core/documentation/schema-feld-haertung.md` — A3 (`Type.Any()` → `Type.Unknown()`)
- `panary-core/documentation/library-publishing.md` — `@panary/*`-Publish-Ablauf (§4)
- `panary-cloud/documentation/versions-konsistenz-und-update-hinweis.md` — UI-Reload bei Versionsbump
