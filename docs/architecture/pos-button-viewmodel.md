...
description: Typisiertes PosButton-View-Model mit toPosButton-Shallow-Copies verhindert, dass der POS-Bestelldialog geteilte ProductService-Cache-Objekte mutiert.
tags: [orders, products, pos, ui]
status: stable
