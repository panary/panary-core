...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions>
      <button class="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 text-slate-700 dark:text-gray-200 rounded-xl px-4 h-10 hover:bg-slate-100 dark:hover:bg-gray-700 transition-colors" (click)="close()">{{ 'COMMON.CLOSE' | translate }}</button>
    </mat-dialog-actions>
  `,
})
