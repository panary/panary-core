...
description: Neues details-JSON-Feld am sync-run-Event persistiert pro Sync-Vorgang die betroffenen Records für Per-Record-Nachvollziehbarkeit in der Admin-Sync-Historie.
tags: [sync, admin]
status: draft
generated: { by: claude-code/historic, at: 2026-05-21T00:00:00Z }
---
...
- **Cloud-Gegenstück:** Die Cloud persistiert jeden Reject zusätzlich in der
  ...
  `panary-cloud/docs/architecture/sync-reject-audit.md`.
