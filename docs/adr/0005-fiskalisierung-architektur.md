...
description: 'ADR zur Dual-Mode-TSE-Architektur: Fiskalisierung als eigenes Feature mit Cloud-direkter Signierung, entkoppelt von Offline-First und Edge-Hardware.'
tags: [tse, tenants, locations, orders, businessdays]
status: stable
decision: accepted
implementation: Implementierung phasenweise
