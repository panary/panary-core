...
* [Fluide POS-UI-Skalierung & Terminal-Density — Mechanik-Referenz](pos-fluid-ui-scaling.md) - Referenz der Skalierungs-Mechanik im POS-Client — CSS-Tokens, Klassen-Gate, Tailwind-Variant fluid, Terminal-Density via device.uiScale, UiScaleService-Persistenz und px-Audit.
...
* [Filial-Hub (Edge-Server) — Anforderungen und offene Liefermodell-Entscheidung](filial-hub-anforderungen.md) - Anforderungen an einen Filial-Hub, der mehrere POS-Geräte einer Filiale offline-fähig bündelt, samt der offenen Entscheidung über das Liefermodell.
* [Mobile-POS-Strategie — POS-Client auf iPad, iOS, Android und Sunmi mit Stripe Tap to Pay](mobile-pos-strategie.md) - Recherche und Empfehlung, auf welchen Geräteklassen der POS-Client laufen soll und wie kartenlose Zahlung per Stripe Tap to Pay einzuordnen ist.
