...
description: Setup, Sicherheit und Betrieb des geteilten Org-Level self-hosted GitHub-Actions-Runners für core und cloud auf dem Staging-Host als systemd-Dienst.
tags: [ci, infra, ops]
status: stable
implementation: aktiv, Setup ausstehend
generated: { by: claude-code/historic, at: 2026-06-19T00:00:00Z }
---
...
- Deployment-Integration: `panary-cloud/docs/infrastructure/deployment-staging.md` §8
