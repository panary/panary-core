...
1. **„Dialoge sind ihrer Natur nach monolithisch"** — dokumentierte Abbruch-Entscheidung des
   God-Component-Zerlegungsprogramms in `panary-cloud/documentation/tech-debt-backlog.md`
...
2. **Phase-5-Sharing-Plan** — `panary-cloud/documentation/shopify-layout-migration-plan.md` sieht
...
- Gleiches Vorgehen im Schwester-Fall `storefront-editor.component.ts` (panary-cloud):
  dort dokumentiert in `panary-cloud/documentation/tech-debt-backlog.md`.
