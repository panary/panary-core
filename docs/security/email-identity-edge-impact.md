...
description: 'Auswirkungen der E-Mail-Login-Umstellung auf Edge und geteiltes Users-Schema: optionale loginname/password-Felder, accountId und Cloud-zu-Edge-Sync-Projektion.'
tags: [users, auth, sync]
status: stable
...
`panary-cloud/docs/adr/0008-email-identity-multi-tenant-membership.md`. Dieses Dokument hält
