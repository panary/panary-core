...
export type CorporateCustomerParams = KnexAdapterParams<CorporateCustomerQuery> & MongoDBAdapterParams & Params

// Service Interface - can be either KnexService or MongoDBService
export interface CorporateCustomerService extends ServiceInterface<
  CorporateCustomer,
  CorporateCustomerData,
