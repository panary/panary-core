...
description: 'Geteilte RBAC-Bausteine in @panary/users/domain mit hasEffectivePermission als einziger Match-Wahrheit, grant-Format und Capability-Bundles für additive Pro-User-Berechtigungen.'
tags: [users, rbac, permissions]
status: stable
generated: { by: claude-code/historic, at: 2026-06-17T00:00:00Z }
---
...
[panary-cloud/docs/security/granulare-berechtigungen.md](../../../panary-cloud/docs/security/granulare-berechtigungen.md)
dokumentiert.
