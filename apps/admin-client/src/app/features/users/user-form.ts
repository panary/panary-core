      ...
      <form #f="ngForm" (ngSubmit)="onSave(f)" class="space-y-5">
        ...
        <div class="flex items-center gap-6 pt-2">
          <label class="flex items-center gap-2 cursor-pointer">
            <input [(ngModel)]="form.isPosUser" name="isPosUser" type="checkbox" class="w-4 h-4 accent-white" />
        ...
        @if (form.isPosUser) {
          <div class="grid grid-cols-2 gap-4">
            <div class="space-y-1">
              <label class="text-xs font-medium text-gray-400 uppercase tracking-wider">Personalnummer (6 Ziffern)</label>
              ...
              @if (employeeNumber.invalid && employeeNumber.touched) {
                <p class="text-red-400 text-xs mt-1">Genau 6 Ziffern.</p>
              }
            </div>
            <div class="space-y-1">
              <label class="text-xs font-medium text-gray-400 uppercase tracking-wider">POS-PIN (4–6 Ziffern)</label>
              ...
              @if (posPin.invalid && posPin.touched) {
                <p class="text-red-400 text-xs mt-1">4–6 Ziffern.</p>
              }
            </div>
          </div>
        }
        ...
        <div class="border-t border-gray-800 pt-4 space-y-4">
          <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Personalessen & Rabatt</p>

          <label class="flex items-center gap-2 cursor-pointer">
            <input [(ngModel)]="form.allowStaffMealOrders" name="allowStaffMealOrders" type="checkbox"
              class="w-4 h-4 accent-white" />
            <span class="text-sm text-gray-300">Personalessen berechtigt</span>
          </label>

          @if (form.allowStaffMealOrders) {
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1">
                <label class="text-xs text-gray-500 uppercase tracking-wider">Rabatt-Typ</label>
