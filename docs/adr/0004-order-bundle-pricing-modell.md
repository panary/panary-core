...
description: Generisches components-Modell auf der Order-Zeile und die kanonische Engine computeOrderTax vereinheitlichen Brutto- und Steuer-Split inklusive FIXED_PROPORTIONAL-Festpreisverteilung.
tags: [orders, products, businessdays, pricing, tax]
status: stable
decision: accepted
