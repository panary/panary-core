...
* [Edge startet nicht — FEATHERS_SECRET fehlt oder ist der Platzhalter](edge-feathers-secret-pflicht.md) - Seit der Boot-Härtung bricht der Edge ab, statt JWTs mit dem Platzhalter aus dem öffentlichen Repo zu signieren; dieser Guide nennt Meldung, Ursachen und den Weg zurück in den Betrieb.
* [Die vier Target-Gates — wogegen sie stehen und was sie nicht sehen](nx-target-gates.md) - Übersicht der Nx-Target-Gates in der CI (Leerstand, Überschreibung, Caching) samt der Fehlerklasse dahinter — ein Target, das nicht das tut, was sein Name verspricht, meldet grün.
