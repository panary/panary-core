...
description: Entwicklungs-Guide zur ensureIndexes()-Factory als einzige zulässige Methode, DB-Indexe in Service-Modulen idempotent für SQLite und MongoDB zu deklarieren.
tags: [shared-backend, api-edge, database]
status: stable
